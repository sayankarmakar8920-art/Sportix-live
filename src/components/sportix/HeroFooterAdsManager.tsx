...
export default function HeroFooterAdsManager() {
  ...
  return (
    <div className="space-y-5 min-w-0">
        ...
        <AnimatePresence mode="wait">
          <motion.div key="overview" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-4">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <GlassCard>
                <h3 className="text-sm font-semibold text-white mb-4">Placement Distribution</h3>
                    ...
                    return (
                      <div key={d.name} className="space-y-1">
                        ...
                        <div className="h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.06)' }}>
                          <motion.div initial={{ width: 0 }} animate={{ width: `${pct}%` }} transition={{ duration: 1, ease: 'easeOut' }} className="h-full rounded-full" style={{ background: d.color }} />
                        </div>
                      </div>
                    )
                  })}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button onClick={() => setAdEnabled(!adEnabled)} className="relative h-6 w-11 rounded-full transition-colors"
                      ...
                      <motion.div className="absolute top-0.5 h-5 w-5 rounded-full bg-white shadow-md"
                        animate={{ left: adEnabled ? 22 : 2 }} transition={{ type: 'spring', stiffness: 500, damping: 30 }} />
                    </button>
                  </div>
                </div>
            ...
            <GlassCard style={{ padding: 0 }}>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[11px]">
                  ...
                  <tbody>
                    {paged.map(ad => (
                      <motion.tr key={ad.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                        ...
                        <td className="px-4 py-3 font-mono whitespace-nowrap" style={{ color: C.textSec }}>{ad.size}</td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3 font-medium text-white whitespace-nowrap">{fmtCur(ad.revenue)}</td>
                        <td className="px-4 py-3">
      ...
      {activeTab === 'top-ads' && (
        <AnimatePresence mode="wait">
          <motion.div key="top-ads" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-4">
            <GlassCard>
              ...
              <div className="space-y-3">
                {topAds.map((ad, i) => (
                  <motion.div key={ad.id} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.08 }}
                    className="flex items-center gap-4 rounded-xl p-3.5 transition-all hover:bg-white/[0.02]"
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => setShowDesktop(!showDesktop)} className="relative h-6 w-11 rounded-full transition-colors" style={{ background: showDesktop ? C.success : 'rgba(255,255,255,0.1)' }}>
                    <motion.div className="absolute top-0.5 h-5 w-5 rounded-full bg-white shadow-md" animate={{ left: showDesktop ? 22 : 2 }} transition={{ type: 'spring', stiffness: 500, damping: 30 }} />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => setShowTablet(!showTablet)} className="relative h-6 w-11 rounded-full transition-colors" style={{ background: showTablet ? C.success : 'rgba(255,255,255,0.1)' }}>
                    <motion.div className="absolute top-0.5 h-5 w-5 rounded-full bg-white shadow-md" animate={{ left: showTablet ? 22 : 2 }} transition={{ type: 'spring', stiffness: 500, damping: 30 }} />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => setShowMobile(!showMobile)} className="relative h-6 w-11 rounded-full transition-colors" style={{ background: showMobile ? C.success : 'rgba(255,255,255,0.1)' }}>
                    <motion.div className="absolute top-0.5 h-5 w-5 rounded-full bg-white shadow-md" animate={{ left: showMobile ? 22 : 2 }} transition={{ type: 'spring', stiffness: 500, damping: 30 }} />
                  </button>
                </div>
                <div className="h-px" style={{ background: C.border }} />
